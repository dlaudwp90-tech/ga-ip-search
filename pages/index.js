  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        td { padding: 8px 10px; border-bottom: 1px solid #f0f2f8; }
        .dark td { border-bottom-color: #334155; }

        /* 1행 고정 td */
        .td-nowrap { white-space: nowrap; vertical-align: middle; }
