  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        .logo-area { margin-top: 10vh; margin-bottom: 20px; text-align: center; transition: margin 0.3s; }
        .searched .logo-area { margin-top: 20px; margin-bottom: 10px; }
        .searched .logo-area:hover .logo-hint { opacity: 1; }

        /* Guardian & Angel 로고 - 축소판 */
        .logo-wrap { display: inline-block; text-align: center; }
        .logo-top-rule {
          width: 96px; height: 1px; background: #13274F;
          margin: 0 auto 3px;
        }
        .logo-main {
          font-family: 'Playfair Display', 'Georgia', serif;
          font-size: 10px; font-weight: 700;
          color: #13274F; letter-spacing: 0px; line-height: 1.1;
          margin: 0;
        }
        ...
        .logo-sub-en {
          ...
          color: #13274F; letter-spacing: 1px;
          margin: 2px 0 2px;
        }
        .dark .logo-sub-en { color: #94a3b8; }
        .logo-mid-rule {
          width: 56px; height: 1px; background: #13274F;
          margin: 0 auto 2px;
        }
        ...
        .logo-sub-kr {
          ...
          color: #13274F; letter-spacing: 0.2px;
          margin: 0 0 2px;
        }
        ...
        .subtitle {
          ...
          letter-spacing: 1.5px; font-family: 'Noto Sans KR', sans-serif;
        }

        /* 검색 후 로고 */
        .searched .logo-main { font-size: 8px; }
        .searched .logo-sub-en { font-size: 2px; }
        .searched .logo-sub-kr { font-size: 3px; }
        .searched .logo-top-rule, .searched .logo-bot-rule { width: 60px; }
        .searched .logo-mid-rule { width: 36px; }

        @media (max-width: 480px) {
          .logo-main { font-size: 8px; }
          .logo-top-rule, .logo-bot-rule { width: 70px; }
        }
        ...
        .search-box {
          ...
          border: 2px solid #d0d9f0; border-radius: 14px;
          padding: 6px 6px 6px 14px;
          box-shadow: 0 4px 20px rgba(26,58,143,0.10); gap: 8px;
        }
        ...
        .search-btn {
          background: #1a3a8f; color: #fff; border: none; border-radius: 10px;
