  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="G&A IP 문서 통합 검색" />
        ...
        <meta name="twitter:title" content="G&A IP 문서 통합 검색" />
      ...
      <div className={`page${searched ? " searched" : ""}${dark ? " dark" : ""}`}>
        ...
        <div className="logo-area" onClick={searched ? handleClear : undefined} style={searched ? { cursor: "pointer" } : {}}>
          <h1 className="logo">
            <span className="logo-ga">G<span className="logo-amp">&amp;</span>A</span>
      ...
      <style jsx>{`
        ...
        .searched .logo-area { margin-top: 28px; margin-bottom: 16px; }
        .searched .logo-area:hover .logo-hint { opacity: 1; }

        /* 새 로고 디자인 - 심플하고 전문적 */
        .logo {
          display: inline-flex; align-items: center; gap: 14px;
          font-size: 36px; font-weight: 800; letter-spacing: -0.5px; line-height: 1;
          font-family: 'Noto Sans KR', sans-serif;
        }
        .logo-ga {
          color: #111827; font-size: 36px; font-weight: 900; letter-spacing: -1px;
        }
        .dark .logo-ga { color: #f1f5f9; }
        .logo-amp {
          color: #1d4ed8; font-weight: 900;
        }
        .dark .logo-amp { color: #60a5fa; }
        .logo-divider {
          display: inline-block; width: 1.5px; height: 28px;
          background: linear-gradient(to bottom, transparent, #94a3b8, transparent);
          vertical-align: middle; flex-shrink: 0;
        }
        .logo-ip {
          color: #1d4ed8; font-size: 22px; font-weight: 700;
          letter-spacing: 3px; text-transform: uppercase;
        }
        .dark .logo-ip { color: #60a5fa; }

        .logo-hint {
          font-size: 11px; color: #94a3b8; margin-top: 4px;
          opacity: 0; transition: opacity 0.2s; letter-spacing: 0.3px;
        }
        .subtitle { color: #6b7280; font-size: 14px; margin-top: 10px; letter-spacing: 0.3px; }
