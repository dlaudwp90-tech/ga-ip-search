  ...
  return (
    <>
                                ...
                                <div className="file-links">
                                  ...
                                  {hasMore && (
                                    <button className="expand-btn" onClick={(e) => { e.stopPropagation(); toggleRow(i); }}>
                                      {isExpanded ? "▲ 접기" : `▼ ${files.length - COLLAPSE_LIMIT}개 더보기`}
                                    </button>
                                  )}
                                </div>
                              );
      ...
      <style jsx>{`
        ...
        .dark .expand-btn { border-color: #334155; color: #818cf8; }
        .dark .expand-btn:hover { background: #1e2d4a; }
