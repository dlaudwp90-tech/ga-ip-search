  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        .logo-top-rule {
          width: 480px; height: 1px; background: #13274F;
          margin: 0 auto 14px;
        }
        .logo-main {
        ...
        .logo-sub-en {
          ...
          color: #13274F; letter-spacing: 4px;
          margin: 8px 0 10px;
        }
        .dark .logo-sub-en { color: #94a3b8; }
        .logo-mid-rule {
          width: 280px; height: 1px; background: #13274F;
          margin: 0 auto 10px;
        }
        ...
        .subtitle {
          color: #6b7280; font-size: 13px; margin-top: 10px;
          letter-spacing: 2px; font-family: 'Noto Sans KR', sans-serif;
        }

        /* 검색 후 로고 축소 */
        .searched .logo-main { font-size: 28px; }
        .searched .logo-sub-en { font-size: 10px; letter-spacing: 3px; margin: 4px 0 6px; }
        .searched .logo-sub-kr { font-size: 14px; margin-bottom: 6px; }
        .searched .logo-top-rule, .searched .logo-bot-rule { width: 280px; }
        .searched .logo-mid-rule { width: 160px; }

        @media (max-width: 480px) {
          .logo-main { font-size: 32px; }
          .logo-top-rule, .logo-bot-rule { width: 300px; }
          .logo-sub-kr { font-size: 16px; }
          .searched .logo-main { font-size: 20px; }
